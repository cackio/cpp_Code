...
public:
    ...
    void init(int level, const char* path = "/root/log/", 
...
private:
    const int LOG_PATH_LEN = 256;    // 日志文件最长文件名
    const int LOG_NAME_LEN = 256;    // 日志最长名字
    const int MAX_LINES = 50000;     // 日志文件内的最长日志条数
